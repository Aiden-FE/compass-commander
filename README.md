...
本文将以ESM包为产物搭建,以适应社区[CommonJS to ESM](https://gist.github.com/sindresorhus/a39789f98801d908bbc7ff3ecc99d99c)的变化.
...
`touch .gitignore` 创建git忽略配置,具体内容因人而异,这里不做展示
...
> 如果你使用了@rollup/plugin-node-resolve的话,需要提供选项{ exportConditions: ["node"] }以支持构建
